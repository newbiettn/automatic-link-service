...
public class MyStopWords {
	...
	static {
		final List<String> stopWords = Arrays.asList("a", "able", "about",
				"above", "abst", "accordance", "according", "accordingly",
				"across", "act", "actually", "added", "adj", "adopted",
				...
				"came", "can", "cannot", "can’t", "cause", "causes", "certain",
				"certainly", "co", "com", "come", "comes", "contain",
				"containing", "contains", "could", "couldnt", "d", "date",
				"did", "didn’t", "different", "do", "does", "doesn’t", "doing",
				"done", "don’t", "down", "downwards", "due", "during", "e",
				...
				"just", "k", "keep", " keeps", "kept", "keys", "kg", "km",
				"know", "known", "knows", "l", "largely", "last", "lately",
				"later", "latter", "latterly", "least", "less", "lest", "let",
				"lets", "like", "liked", "likely", "line", "little", "‘ll",
				"look", "looking", "looks", "ltd", "m", "made", "mainly",
				...
				"specifically", "specified", "specify", "specifying", "state",
				"states", "still", "stop", "strongly", "sub", "substantially",
				...
				"that’ve", "the", "their", "theirs", "them", "themselves",
				"then", "thence", "there", "thereafter", "thereby", "thered",
				"therefore", "therein", "there’ll", "thereof", "therere",
				"theres", "thereto", "thereupon", "there’ve", "these", "they",
				"theyd", "they’ll", "theyre", "they’ve", "think", "this",
				"those", "thou", "though", "thoughh", "thousand", "throug",
				"through", "throughout", "thru", "thus", "til", "tip", "to",
				"together", "too", "took", "toward", "towards", "tried",
				"tries", "truly", "try", "trying", "ts", "twice", "two", "u",
				"un", "under", "unfortunately", "unless", "unlike", "unlikely",
				"until", "unto", "up", "upon", "ups", "us", "use", "used",
				...
				"www", "x", "y", "yes", "yet", "you", "youd", "you’ll", "your",
				"youre", "yours", "yourself", "yourselves", "you’ve", "z",
				"zero");
